...
class StatusParser {
    ...
    func parseStatus2(values: [CShort]){
        ...
        WifiDevice.shared.WIFI_HR_SS_CH3_ALARM_MIN_STATUS = (Int(values[1]) != 0) ? false : true
        WifiDevice.shared.WIFI_HR_SS_CH3_ALARM_MAX_STATUS = (Int(values[2]) != 0) ? false : true
    
        WifiDevice.shared.WIFI_HR_SS_CH3_ALARM_STATUS = Int(values[3])
        
        WifiDevice.shared.WIFI_HR_SS_RESERVED_36 = Int(values[4])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_37 = Int(values[5])
        
        WifiDevice.shared.WIFI_HR_SS_BATTERY_VOLTAGE_VALUE = Int(values[6])
        WifiDevice.shared.WIFI_HR_SS_BATTERY_VOLTAGE_VALUE_MIN = Int(values[7])
        WifiDevice.shared.WIFI_HR_SS_BATTERY_VOLTAGE_VALUE_MAX = Int(values[8])
        WifiDevice.shared.WIFI_HR_SS_BATTERY_PERCENTAGE_OF_LIFE = Int(values[9])

        WifiDevice.shared.WIFI_HR_SS_RESERVED_38 = Int(values[10])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_39 = Int(values[11])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_40 = Int(values[12])

        WifiDevice.shared.WIFI_HR_SS_EXTERNAL_VOLTAGE_VALUE = Int(values[13])
        WifiDevice.shared.WIFI_HR_SS_EXTERNAL_VOLTAGE_VALUE_MIN = Int(values[14])
        WifiDevice.shared.WIFI_HR_SS_EXTERNAL_VOLTAGE_VALUE_MAX = Int(values[15])

        WifiDevice.shared.WIFI_HR_SS_RESERVED_52 = Int(values[16])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_53 = Int(values[17])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_54 = Int(values[18])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_55 = Int(values[19])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_56 = Int(values[20])

        WifiDevice.shared.WIFI_HR_SS_WIFI_LAST_UPDATE_YEAR  = Int(values[21])
        WifiDevice.shared.WIFI_HR_SS_WIFI_LAST_UPDATE_MONTH  = Int(values[22])
        WifiDevice.shared.WIFI_HR_SS_WIFI_LAST_UPDATE_DAY  = Int(values[23])
        WifiDevice.shared.WIFI_HR_SS_WIFI_LAST_UPDATE_HOUR  = Int(values[24])
        WifiDevice.shared.WIFI_HR_SS_WIFI_LAST_UPDATE_MINUTE  = Int(values[25])
        WifiDevice.shared.WIFI_HR_SS_WIFI_LAST_UPDATE_SECOND  = Int(values[26])
        WifiDevice.shared.WIFI_HR_SS_WIFI_FTP_LAST_UPDATE_TIME_H  = Int(values[27])
        WifiDevice.shared.WIFI_HR_SS_WIFI_FTP_LAST_UPDATE_TIME_L  = Int(values[28])
        WifiDevice.shared.WIFI_HR_SS_WIFI_CLOUD_LAST_UPDATE_TIME_H  = Int(values[29])
        WifiDevice.shared.WIFI_HR_SS_WIFI_CLOUD_LAST_UPDATE_TIME_L  = Int(values[30])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_1_BACKUPED  = Int(values[31])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_2_BACKUPED  = Int(values[32])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_3_BACKUPED  = Int(values[33])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_4_BACKUPED  = Int(values[34])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_5_BACKUPED  = Int(values[35])
        WifiDevice.shared.WIFI_HR_SS_WIFI_IRSS  = Int(values[36])
        WifiDevice.shared.WIFI_HR_SS_WIFI_ERROR_COM  = Int(values[37])
        WifiDevice.shared.WIFI_HR_SS_WIFI_ERROR_MQTT  = Int(values[38])
        WifiDevice.shared.WIFI_HR_SS_WIFI_ERROR_MODBUS  = Int(values[39])
        ...
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_14  = Int(values[49])

        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_15  = Int(values[50])
        WifiDevice.shared.WIFI_HR_SS_WIFI_LAST_STATUS_YEAR  = Int(values[51])
        WifiDevice.shared.WIFI_HR_SS_WIFI_LAST_STATUS_MONTH_BROKER  = Int(values[52])
        WifiDevice.shared.WIFI_HR_SS_WIFI_LAST_STATUS_DAY_BROKER  = Int(values[53])
        WifiDevice.shared.WIFI_HR_SS_WIFI_LAST_STATUS_HOUR_BROKER  = Int(values[54])
        WifiDevice.shared.WIFI_HR_SS_WIFI_LAST_STATUS_MINUTE_BROKER  = Int(values[55])
        WifiDevice.shared.WIFI_HR_SS_WIFI_LAST_STATUS_SECOND_BROKER  = Int(values[56])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_22  = Int(values[57])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_23  = Int(values[58])
        WifiDevice.shared.WIFI_HR_SS_WIFI_LAST_STATUS_YEAR_FTP  = Int(values[59])
            
        WifiDevice.shared.WIFI_HR_SS_WIFI_LAST_STATUS_MONTH_FTP  = Int(values[60])
        
        WifiDevice.shared.WIFI_HR_SS_WIFI_LAST_STATUS_DAY_FTP  = Int(values[61])
        WifiDevice.shared.WIFI_HR_SS_WIFI_LAST_STATUS_HOUR_FTP  = Int(values[62])
        WifiDevice.shared.WIFI_HR_SS_WIFI_LAST_STATUS_MINUTE_FTP  = Int(values[63])
        WifiDevice.shared.WIFI_HR_SS_WIFI_LAST_STATUS_SECOND_FTP  = Int(values[64])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_30  = Int(values[65])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_31      = Int(values[66])
        WifiDevice.shared.WIFI_HR_SS_WIFI_LAST_STATUS_YEAR_CLOUD  = Int(values[67])
        WifiDevice.shared.WIFI_HR_SS_WIFI_LAST_STATUS_MONTH_CLOUD  = Int(values[68])
        WifiDevice.shared.WIFI_HR_SS_WIFI_LAST_STATUS_DAY_CLOUD  = Int(values[69])
        WifiDevice.shared.WIFI_HR_SS_WIFI_LAST_STATUS_HOUR_CLOUD  = Int(values[70])
        WifiDevice.shared.WIFI_HR_SS_WIFI_LAST_STATUS_MINUTE_CLOUD  = Int(values[71])
        WifiDevice.shared.WIFI_HR_SS_WIFI_LAST_STATUS_SECOND_CLOUD  = Int(values[72])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_38  = Int(values[73])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_39  = Int(values[74])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_40  = Int(values[75])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_41  = Int(values[76])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_42  = Int(values[77])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_43  = Int(values[78])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_44  = Int(values[79])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_45  = Int(values[80])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_46  = Int(values[81])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_47  = Int(values[82])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_48  = Int(values[83])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_49  = Int(values[84])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_50  = Int(values[85])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_51  = Int(values[86])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_52  = Int(values[87])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_53  = Int(values[88])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_54  = Int(values[89])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_55  = Int(values[90])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_56  = Int(values[91])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_57  = Int(values[92])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_58  = Int(values[93])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_59  = Int(values[94])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_60  = Int(values[95])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_61  = Int(values[96])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_62  = Int(values[97])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_63  = Int(values[98])
        WifiDevice.shared.WIFI_HR_SS_RESERVED_WIFI_64  = Int(values[99])
    }
