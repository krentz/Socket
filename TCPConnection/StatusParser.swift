...
class StatusParser {
    ...
    func parseStatus1(values: [CShort]){
        ...
        WifiDevice.shared.WIFI_macAddr_ble = ParseUtils.shared.formatMacAddress(mac: "\(String(Int(values[5]) & 0xffff, radix: 16))\(String(Int(values[6]) & 0xffff, radix: 16))\(String(Int(values[7]) & 0xffff, radix: 16))")
